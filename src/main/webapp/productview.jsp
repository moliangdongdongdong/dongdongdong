...
<div class="detCon">
    <div class="proDet wrapper">
        <div class="proCon clearfix">
            <div class="proImg fl">
                <img class="det" src="${pageContext.request.contextPath}/images/product/${product.product_filename}"/>
                <div class="smallImg clearfix">
                    <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                    <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                    <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                    <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                </div>
            ...
            <div class="fr intro">
                <div class="title"><h4>【喵喵】${product.product_name}</h4>
                    <p>【${product.product_desc}】</p><span>￥${product.product_price}.00</span></div>
                <div class="proIntro"><p>颜色分类</p>
                    <div class="smallImg clearfix categ">
                        ...
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" alt="白瓷花瓶+20支快乐花" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                        </p>
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" alt="白瓷花瓶+20支兔尾巴草" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                        </p>
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" alt="20支快乐花" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                        </p>
                        <p class="fl">
                            <img src="${pageContext.request.contextPath}/images/product/${product.product_filename}" data-src="${pageContext.request.contextPath}/images/product/${product.product_filename}">
                        </p>
        ...
        <div class="seeList">
            <c:forEach var="cp" items="${classlist}">
                <a href="selectproductview?id=${cp.product_id}">
                    <dl>
                        <dt><img src="${pageContext.request.contextPath}/images/product/${cp.product_filename}" style="width: 160px;height: 200px;"></dt>
                        <dd>【喵喵】${cp.product_name}</dd>
