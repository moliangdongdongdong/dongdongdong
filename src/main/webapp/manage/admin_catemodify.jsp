...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a
                class="crumb-name" href="admin_user.jsp">分类管理</a><span class="crumb-step">&gt;</span><span>修改分类</span>
        </div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="${pageContext.request.contextPath}/manage/admin_docateupdate" method="post" id="myform"
                  name="myform">
                ...
                <table class="insert-tab" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="common-text required" id="title" name="classname" size="50" value="${cate1.cate_name}"
                                   type="text">
                        </td>
                    </tr>
