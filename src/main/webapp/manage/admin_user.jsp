            ...
            <form action="${pageContext.request.contextPath}/manage/admin_douserselect" method="get">
                <table class="search-tab">
                    <tr>
                        ...
                        <th width="70">关键字:</th>
                        <td><input class="common-text" placeholder="关键字" name="keywords" value="${param.keywords}" id=""
                                   type="text">
                        </td>
                ...
                <table class="result-tab" width="100%">
                    ...
                    <c:forEach var="users" items="${userlist}">
                        <tr>
                            ...
                            <td>
                                <a class="link-update"
                                   href="admin_touserupdate?id=${users.user_id}&cpage=${cpage}">修改</a>
                                <c:if test="${users.user_status==1}">
                                    <a class="link-del"
                                       href="javascript:Delete('你确定要删除用户【${users.user_id}】吗', '${pageContext.request.contextPath}/manage/admin_douserdel?id=${users.user_id}&cpage=${cpage}')">删除</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
