...
<div class="address">
    <div class="wrapper clearfix"><a href="indexselect">首页</a><span>/</span><a
            href="">喵喵商城</a><span>/</span><a href="proList.html" class="on">${title}</a></div>
</div><!-------------------current---------------------->
<div class="current">
...
<ul class="proList wrapper clearfix">
    <c:forEach var="plist" items="${list}">
        <li><a href="selectproductview?id=${plist.product_id}">
            <dl>
                <dt><img src="${pageContext.request.contextPath}/images/product/${plist.product_filename}"></dt>
                <dd>【喵喵】${plist.product_name}</dd>
                <dd>￥${plist.product_price}.00</dd>
            </dl>
        </a></li>
    </c:forEach>
